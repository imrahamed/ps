...
var FirstComponent = (function () {
    function FirstComponent(_route, _router, _productService) {
        this._route = _route;
    ...
    FirstComponent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
    };
    FirstComponent.prototype.getProduct = function (colCode) {
        var _this = this;
    ...
    FirstComponent.prototype.onBack = function () {
        this._router.navigate(['/arts']);
    };
    FirstComponent.prototype.onRatingClicked = function (message) {
